...
screen preferences():
    ...
    use game_menu(_("Prefs"), scroll="viewport"):
        ...
        vbox: # Find your screens.rpy file and place this vbox somewhere inside it. (The exact location within the Preferences Screen is based on your project's needs!)
            ...
            textbutton _("{font=DynaPuff.ttf}Enabled") action [SetVariable("persistent.voice_acting",True), SetMute(['voice','yell'], False)]
            textbutton _("{font=DynaPuff.ttf}Disabled") action [SetVariable("persistent.voice_acting",False), SetMute(['voice','yell'], True)]